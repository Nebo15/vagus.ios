              ...
              inView:(UIView*)baseView
{
    ...
    float widthBounds = [[UIScreen mainScreen] bounds].size.width-40.0f;
	CGSize messageSize = [message sizeWithFont:[UIFont fontWithName:DEFAULT_FONTNAME size:DEFAULT_FONTSIZE]
							 constrainedToSize:CGSizeMake(widthBounds, 9999.0f)
	...
	messageSize.width += messageRect.origin.x*2 + borderWidth;
